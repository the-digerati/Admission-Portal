  ...
  return (
    <div className='main'>
      ...
      <label class="block">
        ...
        <input type="password" name="PIN" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:ring-sky-500 block w-full rounded-md sm:text-sm " maxLength={5} required placeholder="PIN"></input>
      </label>
